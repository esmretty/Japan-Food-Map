...
async function scrapeList() {
  ...
  // Tabelog search URL for Tokyo, rating 3.80 to 3.84
  // We need to find the right pages. Let's start from page 15 where scores might drop to 3.84
  for (let page = 15; page <= 30; page++) {
