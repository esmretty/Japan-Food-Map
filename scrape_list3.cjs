...
async function scrapeList() {
  ...
  // We need to find the right pages for 3.75 - 3.79.
  // Last time page 31 reached below 3.80. Let's start from page 31.
  for (let page = 31; page <= 60; page++) {
    ...
    if (foundBelowRange) {
      console.log("Reached scores below 3.75. Stopping.");
      break;
    }
  ...
  console.log(`Found ${newRestaurants.length} new restaurants in 3.75-3.79 range.`);
